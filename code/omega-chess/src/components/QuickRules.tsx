        ...
        <main className="flex flex-col overflow-y-auto gap-y-3">
            <div className="rounded-lg bg-zinc-600 mr-2">
                ...
                <ul className="list-disc list-inside pl-2 justify-evenly">
                    <li className="text-md"> Ogni giocatore ha una scacchiera separata senza vedere le mosse dell'avversario. </li>
                    <li className="text-md"> L'arbitro gestisce una terza scacchiera con la posizione completa. </li>
                </ul>
            </div>
            <div className="rounded-lg bg-zinc-600 mr-2">
                <h1 className="text-xl font-bold text-center"> Arbitro </h1>
                <ul className="list-disc list-inside pl-2 justify-evenly">
                    <li className="text-md"> Comunica con i giocatori per annunciare l'esito delle mosse. </li>
                    <li className="text-md"> Annuncia il cambio di turno se la mossa è legale, altrimenti dichiara "mossa illegale". </li>
                </ul>
            </div>
            <div className="rounded-lg bg-zinc-600 mr-2">
                <h1 className="text-xl font-bold text-center"> Scacco e Cattura </h1>
                <ul className="list-disc list-inside pl-2 justify-evenly">
                    <li className="text-md"> L'arbitro annuncia uno scacco, specificando la direzione. </li>
            ...
            <div className="rounded-lg bg-zinc-600 mr-2">
                ...
                <ul className="list-disc list-inside pl-2 justify-evenly">
                    <li className="text-md"> Prima di ogni mossa, l'arbitro comunica il numero di catture di pedone possibili. </li>
            ...
            <div className="rounded-lg bg-zinc-600 mr-2">
                ...
                <ul className="list-disc list-inside pl-2 justify-evenly">
                    <li className="text-md"> L'arbitro annuncia scacco matto, terminando la partita. </li>
                    <li className="text-md"> Condizioni di patta seguono le regole standard, con l'eccezione della patta per impossibilità di dare scacco matto </li>
